...
public class FormalParemDecls extends FormalParamList {

    private FormalParamList FormalParamList;
    private FormalParamDecl FormalParamDecl;

    public FormalParemDecls (FormalParamList FormalParamList, FormalParamDecl FormalParamDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormalParemDecls(\n");
